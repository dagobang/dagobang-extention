...
export type AutoTradeTwitterSnipeRuntimeStrategy = AutoTradeStrategyBase & {
  ...
  rapidHoldSeconds?: string;
  rapidEvalStepSec?: string;
  rapidLookbackSec?: string;
  rapidEmergencyConfirmSteps?: string;
  rapidEmergencyStopLossPct?: string;
  rapidRouteCut1Pct?: string;
  rapidRouteCut2Pct?: string;
  rapidExit20Sec?: string;
  rapidStage1Sec?: string;
  rapidStage2Sec?: string;
  rapidStage3Sec?: string;
  rapidStage4Sec?: string;
  rapidStage1ProfitPct?: string;
  rapidStage2ProfitPct?: string;
  rapidStage3ProfitPct?: string;
  rapidStage4ProfitPct?: string;
  rapidStage1SellPct?: string;
  rapidStage2SellPct?: string;
  rapidStage3SellPct?: string;
  rapidStage4SellPct?: string;
  rapidRunnerArmProfitPct?: string;
  rapidRunnerPeakCut1Pct?: string;
  rapidRunnerPeakCut2Pct?: string;
  rapidRunnerDrawdown1Pct?: string;
  rapidRunnerDrawdown2Pct?: string;
  rapidRunnerDrawdown3Pct?: string;
  targetUsers: string[];
