...
declare module '#imports' {
  ...
  export { isUsableFlapDexPoolAddress, hasConfirmedFlapStocksIdentity, hasConfirmedFlapOuterRoute, hasNonTerminalFlapOuterQuote, resolveFlapPlatform, hasConfirmedFlapLaunchpadIdentity, resolveFlapPlatformByQuoteLineage, classifyFlapRoute } from '../utils/flap';
